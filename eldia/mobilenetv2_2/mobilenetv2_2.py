...
train_labels_categorical = tf.keras.utils.to_categorical(train_labels, 2)
...
report = classification_report(true_classes, predicted_classes, target_names=["Low", "High"])
